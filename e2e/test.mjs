...
try {
  ...
  await d.getByPlaceholder(/Responder a agus/).fill("Conexiones salientes inesperadas, para empezar."); await d.keyboard.press("Enter");
  ...
  await enter(m, "eitan", "Policy / regulación");
